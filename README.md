...
| Format | File | Notes |
|--------|------|--------|
| **PDF** | [Resume.pdf](Resume.pdf) | Best for printing and ATS. Open or download. |
| **Markdown** | [Resume.md](Resume.md) | Source; readable on GitHub and in any Markdown viewer. |
...
- **Email:** [william@williamtucker.ca](mailto:william@williamtucker.ca)
